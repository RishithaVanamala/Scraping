...
def scrape_crate_and_barrel(url):
    ...
    with requests.Session() as session:
        ...
        if response.status_code == 200:
            ...
            csv_file_path = os.path.join(csv_folder, 'Benches.csv')  # Use os.path.join to create the correct file path
...
crate_and_barrel_url = 'https://www.crateandbarrel.com/furniture/benches/1'
