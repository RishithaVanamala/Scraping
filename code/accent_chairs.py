...
def scrape_crate_and_barrel(url):
    ...
    with requests.Session() as session:
        ...
        if response.status_code == 200:
            ...
            csv_file_path = os.path.join(csv_folder, 'Chairs.csv')  # Use os.path.join to create the correct file path
            ...
            with open(csv_file_path, 'w', newline='', encoding='utf-8') as csvfile:
                fieldnames = ['Product Id', 'Product Name', 'Price', 'Link of the product', 'Color', 'Scraped Image Link']
...
crate_and_barrel_url = 'https://www.crateandbarrel.com/furniture/chairs/1'
